...
def main():
    ...
    # cp.recup_donnees("donnees_dij.txt",sol_classique[2],len(sol_classique[-1]),n,n)
    # cp.recup_donnees("donnees_bidij.txt",sol_bidij[2],len(sol_bidij[3]+sol_bidij[4]),n,n)
